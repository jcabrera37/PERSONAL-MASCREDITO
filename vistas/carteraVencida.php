...
<head>
    ...
    <link href="../styles/carteraVencida.css" rel="stylesheet" type="text/css">
...
<div class="container">
    <header>Cartera Vencida</header>

    <form action="carteraVencida.php" method="POST">
...
<div class="botones">  
<a class="btn-1" href="<?php echo "../class/imprimir_carteraVencida.php?inicio=" . $inicio . "&fin=" . $fin ?>">imprimir </a>
